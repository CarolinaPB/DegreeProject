...
query.add_view(
    ...
    "goAnnotation.ontologyTerm.name", "goAnnotation.evidence.code.code"
)
...
print("gene", "GO", "GO_term", "evidencecode", sep='\t')
for row in query.rows():
    print(row["secondaryIdentifier"], row["goAnnotation.ontologyTerm.identifier"], \
        row["goAnnotation.ontologyTerm.name"], row["goAnnotation.evidence.code.code"],sep='\t')
