...
There are `r nrow(genesA_start_order[between(start.A,band2.left-1500, band2.right+1500)])` genes between the green lines
...
There are `r nrow(genesA_start_order[between(start.A,band3.left-1500, band3.right+1500)])` genes between the green lines
...
plot_sorted_coordinates(
  ...
  separator = separator,
  col = coordinates_plot_cor[chr.A==12]$col, 
  xlim=c(8955830-2000, 8955830+2000)
)
abline(v=unlist(hotspots$V1), 
       col=as.factor(col), lwd=1.5)
```
