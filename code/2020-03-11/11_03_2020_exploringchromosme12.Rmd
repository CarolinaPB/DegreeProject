...
genes_in_hotspot <- genes_inside_hotspot(hotspot_data = hotspot_data.interval,coordinates_plot_links.200.A, chromosome = seq(1:16), leftlim = 5, rightlim = 6)
```
There are `r length(unlist(genes_in_hotspot))` genes that overlap with hotspots
