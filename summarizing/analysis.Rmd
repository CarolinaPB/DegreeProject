...
```{r}
genes_inside_hotspot(hotspot_data = hotspot_data.interval,coordinates_plot_links.200, 12, lefttlim = 5, rightlim = 6)
```
...
```{r}
genes_inside_hotspot(hotspot_data = hotspot_data.interval,coordinates_plot_links.200, 14, lefttlim = 5, rightlim = 6)
```
...
```{r}
genes_inside_hotspot(hotspot_data = hotspot_data.interval,coordinates_plot_links.200, 15, lefttlim = 5, rightlim = 6)
```
