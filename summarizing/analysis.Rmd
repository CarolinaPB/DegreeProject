...
#knitr::opts_chunk$set(tidy.opts=list(width.cutoff=60),tidy=TRUE) #doesn't seem to work
...
goframeData <- unique(genes_GO.table[,.(GO.identifier, evidence, gene)])
...
genesA <- unlist(unique(find.effects_TF[,geneA])) # causal
genesB <- unlist(unique(find.effects_TF[,geneB])) # affected
