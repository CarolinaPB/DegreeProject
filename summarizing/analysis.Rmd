...
plot_sorted_coordinates(
  ...
  xlim = c(min(genesA_start_order$start.A), band1.right)
)
abline(v=c(band1.left-1500, band1.right), col="green")
```
...
genes_inside_hotspot(hotspot_data = hotspot_data.interval,causal.pos.B.2.order, seq(1:16))
```
